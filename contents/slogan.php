  ...
  <body>
    ...
    <div class="container mb-4">
        <div class="row text-center">
            <div class="col-12">   
                <p class="topicTop">คำขวัญวันครู ประจำปี 2562</p>
            </div>
        </div>
    </div>
        ...
        <div class="row mb-3">
            <div class="col-md-10 col-sm-10 mx-auto">   
                <div class="container mt-3">
                    <h5 class="text-center">คำขวัญวันครู ประจำปี 2562 “ครูดี ศิษย์ดี มีพัฒนา ก้าวหน้า สู่เทคโนโลยี”</h5>
                    <p style="font-size:14px; font-weight:300"></p>
                    <img src="../img/slogan.jpg" alt="สอบครูผู้ช่วย" width="50%" class="img-thumbnail mx-auto d-block"><p></p>
                </div>
            </div>
        </div>
    </div>
