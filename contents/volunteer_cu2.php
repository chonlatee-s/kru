  ...
  <body>
    ...
    <div class="container mb-4">
        <div class="row text-center">
            <div class="col-12">   
                <p class="topicTop">โครงการสอนภาษาไทยและวัฒนธรรมไทยในต่างประเทศ</p>
            </div>
        </div>
    </div>
        ...
        <div class="row mb-3">
            <div class="col-md-10 col-sm-10 mx-auto">   
                <div class="container mt-3">
                    <h5>ครูอาสาสมัครโครงการสอนภาษาไทยและวัฒนธรรมไทยในต่างประเทศ ประจำปี พ.ศ.๒๕๖๒ (รอบที่ ๒)</h5>
                    <p style="font-size:14px; font-weight:300">
                    ศูนย์ส่งเสริมการสอนภาษาไทยและวัฒนธรรมไทย ศาสตราจารย์ ม.ล.จิรายุ – ศาสตราจารย์ท่านผู้หญิงพูนทรัพย์นพวงศ์ 
                    คณะครุศาสตร์จุฬาลงกรณ์มหาวิทยาลัย ประกาศรับสมัคร ครูอาสาสมัครโครงการสอนภาษาไทยและวัฒนธรรมไทยในต่างประเทศ ประจำปี พ.ศ.๒๕๖๒ (รอบที่ ๒)

                    <i>ผู้สนใจสามารถดาวน์โหลดรายละเอียดขั้นตอนการสมัครเพิ่มเติม <a href="../download/cu2.pdf" target="_blank">คลิกที่นี่</a></i>
                    </p>
                    <img src="../img/cu2.jpg" alt="สอบครูผู้ช่วย" class="img-thumbnail mx-auto d-block" width="50%">
                </div>
            </div>
        </div>
        <div class="row mb-3">
