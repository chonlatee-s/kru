...
<div class="container-fluid big_box">
        <div class="container">
            <div class="row text-center">
                <div class="col-12">   
                    <p class="topicTop">ไฟล์อ่านสอบครู อปท</p>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-10 col-sm-10 mx-auto">   
                <div class="container mt-3 text-center">
                    <p style="font-size:14px; font-weight:300">ไฟล์อ่านสอบครู อปท. เครดิตคุณ โตโต้ ตาตี่ตัวโต
                        <a href="https://drive.google.com/drive/u/0/folders/0B4_oMUeJLceNQWJyVUEweml1WmM?fbclid=IwAR15lSGgR__4LCEqDaMZySG_P6et9ecjrnWXgY61mem2kceLM0jWeG8LRII" target="_blank">ดาวน์โหลด</a>
                    </p>
                </div>
            </div>
        </div>
