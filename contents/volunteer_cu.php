  ...
  <body>
    ...
    <div class="container mb-4">
        <div class="row text-center">
            <div class="col-12">   
                <p class="topicTop">ครูอาสาสมัครในต่างประเทศ ประจำปี ๒๕๖๒</p>
            </div>
        </div>
    </div>
        ...
        <div class="row mb-3">
            <div class="col-md-10 col-sm-10 mx-auto">   
                <div class="container mt-3">
                    <h5>ครูอาสาสมัครโครงการสอนภาษาไทย ณ วัดไทยในต่างประเทศ ประจำปี พ.ศ.๒๕๖๒</h5>
                    <p style="font-size:14px; font-weight:300">
                    ศูนย์ส่งเสริมการสอนภาษาไทยและวัฒนธรรมไทย ศาสตราจารย์ ม.ล.จิรายุ – ศาสตราจารย์ท่านผู้หญิงพูนทรัพย์นพวงศ์ 
                    คณะครุศาสตร์จุฬาลงกรณ์มหาวิทยาลัย ประกาศรับสมัคร ครูอาสาสมัครโครงการสอนภาษาไทย ณ วัดไทยในต่างประเทศ ประจำปี พ.ศ.๒๕๖๒

                    <i>โดยท่านผู้สนใจสามารถอ่านคุณสมบัติ รายละเอียดขั้นตอนการสมัคร ผ่านทางประกาศรับสมัครได้ทาง <b><a href="http://bit.ly/2NspNh1" target="_blank">http://bit.ly/2NspNh1</a></b> เปิดรับสมัครวันนี้ ถึงวันที่ ๒๘ ธันวาคม ๒๕๖๑</i>
                    </p>
                    <img src="../img/cu.jpg" alt="สอบครูผู้ช่วย" class="img-thumbnail mx-auto d-block" style="width:700px;"><p></p>
                </div>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-10 mx-auto">
                <p style="font-size:14px; font-weight:300">ข้อมูลอ้างอิง ศูนย์ส่งเสริมการสอนภาษาไทยและวัฒนธรรมไทย ศาสตราจารย์ ม.ล.จิรายุ – ศาสตราจารย์ท่านผู้หญิงพูนทรัพย์นพวงศ์ คณะครุศาสตร์จุฬาลงกรณ์มหาวิทยาลัย</p>
            </div>
        </div>
    </div>
