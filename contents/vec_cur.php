    ...
    <div class="container mb-3" id="contentAll">
        <div class="row mb-3">
            <div class="col-md-10 col-sm-10 mx-auto">   
                <div class="container mt-3">
                    <h5>หลักสูตรประกาศนียบัตรวิชาชีพ (ปวช.) พุทธศักราช 2562</h5>
                    <p style="font-size:14px; font-weight:300">
                        หลักสูตรประกาศนียบัตรวิชาชีพ (ปวช.) พุทธศักราช 2562 รายละเอียด <a href="http://bit.ly/2JlamL1" target="_blank">คลิกที่นี่</a> ทั้งนี้ขอให้สถานศึกษา รอประกาศจากสำนักมาตรฐานการอาชีวศึกษาและวิชาชีพ อย่างเป็นทางการอีกครั้ง
                    </p>
                    <img src="../img/vec.jpg" alt="สอบครูผู้ช่วย" class="img-thumbnail mx-auto d-block"><p></p>
        ...
        <div class="row mb-3">
            <div class="col-10 mx-auto">
                <p style="font-size:14px; font-weight:300"><a href="https://www.facebook.com/nitedvec" target="_blank">ข้อมูลอ้างอิง เพจหน่วยศึกษานิเทศก์ สำนักงานคณะกรรมการการอาชีวศึกษา</a></p>
            </div>
        </div>
    </div>
